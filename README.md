...
| Внутреннее обучение - ряд курсов | GlowByte | рус |  | Курсы: 
1. Письменная фиксация информации 
2. Деловая переписка 
3. Greenplum 
4. Основы баз данных и SQL. Введение в повышение производительности запроса 
5. Общая теория ХД и BI |  |
