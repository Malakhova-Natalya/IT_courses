...
- Очистка данных
  - [Осадки в апреле - пример на отбор нужных значений через row_number и окно](https://github.com/Malakhova-Natalya/IT_courses/blob/main/Оконные%20функции%20SQL/32%20-%20осадки%20в%20апреле.txt)
- Итоги
